    ...
    D: Dispatch<WlBuffer, AndroidBufferData> + 'static,
{
    fn bind(
        ...
        // TODO: Send supported formats - currently causes "interface has no event 0" error
        // The format event may not be properly generated by wayland-scanner
        // AndroidWleglState::send_formats(&wlegl);
        let _ = wlegl; // Suppress unused warning
    }
}
